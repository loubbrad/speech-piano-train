...
IRMAK_ENROOT_SCRATCH_ROOT=/dev/shm/$USER/speech-piano-enroot
IRMAK_DOWNLOAD_DIR=$IRMAK_PROJECT_ROOT/downloads
IRMAK_DATA_ROOT=$IRMAK_PROJECT_ROOT/speech_piano_data
IRMAK_DATASET_DIR=$IRMAK_DATA_ROOT/speech_piano_0.4
...
IRMAK_DATA_ARCHIVE=speech_piano_0.4.tar.gz
